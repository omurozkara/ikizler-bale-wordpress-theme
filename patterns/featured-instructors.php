...
<p class="ikizler-section-label has-rosewood-color has-text-color">Egitmenler</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"fontSize":"xl"} -->
<h2 class="wp-block-heading has-xl-font-size">Egitmen kadrosu hem kurumsal guven hem de sanatsal kaliteyi ilk bakista hissettirmeli.</h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<p class="ikizler-section-label has-blush-color has-text-color">Sanat Yonetimi</p>
<!-- /wp:paragraph -->
...
<p class="has-rosewood-color has-text-color">Cocuk gelisimi, postur bilinci ve aile iletisimini birlikte dusunen kurumsal yaklasim.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"textColor":"rosewood"} -->
<p class="has-rosewood-color has-text-color">Genc gruplarda akicilik ve performans guveni odakli calismalar.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"sizeSlug":"large","linkDestination":"none","style":{"border":{"radius":"30px"}}} -->
<figure class="wp-block-image size-large has-custom-border"><img src="https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?auto=format&amp;fit=crop&amp;w=900&amp;q=80" alt="Egitmen portresi" style="border-radius:30px"/></figure>
<!-- /wp:image -->

<!-- wp:heading {"level":3,"fontSize":"lg"} -->
<h3 class="wp-block-heading has-lg-font-size">Yetiskin Grup Dersleri</h3>
<!-- /wp:heading -->
