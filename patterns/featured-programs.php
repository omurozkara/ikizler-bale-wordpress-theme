...
<h2 class="wp-block-heading has-xl-font-size">Her yas ve seviye icin duzenli, zarif ve net bir egitim kurgusu.</h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"42%"} -->
<div class="wp-block-column" style="flex-basis:42%"><!-- wp:paragraph {"textColor":"rosewood"} -->
<p class="has-rosewood-color has-text-color">Bu bolum daha sonra admin panelinden secilecek gercek egitim icerikleriyle beslenebilir olacak. Faz 1'de estetik iskelet kuruluyor.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<h3 class="wp-block-heading has-lg-font-size">4-6 yas icin keyifli baslangic</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Ritim, esneklik, temel denge ve bale ile tanisma odakli ders yapisi.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:heading {"level":3,"fontSize":"lg"} -->
<h3 class="wp-block-heading has-lg-font-size">Teknik ve sahne guveni bir arada</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Temel teknik, postur ve performans odakli, duzenli gelisimi destekleyen akis.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:heading {"level":3,"fontSize":"lg"} -->
<h3 class="wp-block-heading has-lg-font-size">Baslangic ve ileri seviye secenekleri</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Beden farkindaligi, estetik hareket ve teknik gelisim odakli premium ders kurgusu.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
