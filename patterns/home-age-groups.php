...
<p class="ikizler-section-label has-rosewood-color has-text-color">Yas Gruplari</p>
<!-- /wp:paragraph -->
...
<h3 class="wp-block-heading has-lg-font-size">Temel durus, ritim ve rahat uyum icin yumusak baslangic</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Oyun destekli yaklasim ve guvenli sinif ritmi.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:column {"width":"33%"} -->
<div class="wp-block-column" style="flex-basis:33%"><!-- wp:group {"backgroundColor":"white","className":"ikizler-grid-card","style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"var:preset|spacing|md","left":"0"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group ikizler-grid-card has-white-background-color has-background" style="padding-top:0;padding-right:0;padding-bottom:var(--wp--preset--spacing--md);padding-left:0"><!-- wp:image {"sizeSlug":"large","linkDestination":"none","className":"ikizler-card-media","style":{"border":{"radius":"30px 30px 0 0"}}} -->
<figure class="wp-block-image size-large ikizler-card-media has-custom-border"><img src="https://images.unsplash.com/photo-1518611012118-696072aa579a?auto=format&amp;fit=crop&amp;w=1000&amp;q=80" alt="7-12 yas bale egitimi" style="border-radius:30px 30px 0 0"/></figure>
<!-- /wp:image -->
...
<!-- wp:heading {"level":3,"fontSize":"lg"} -->
<h3 class="wp-block-heading has-lg-font-size">Teknik temel, koordinasyon ve sahne disiplininin oturdugu donem</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Daha belirgin teknik hedefler ve gelisim takibi.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-column" style="flex-basis:33%"><!-- wp:group {"backgroundColor":"white","className":"ikizler-grid-card","style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"var:preset|spacing|md","left":"0"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group ikizler-grid-card has-white-background-color has-background" style="padding-top:0;padding-right:0;padding-bottom:var(--wp--preset--spacing--md);padding-left:0"><!-- wp:image {"sizeSlug":"large","linkDestination":"none","className":"ikizler-card-media","style":{"border":{"radius":"30px 30px 0 0"}}} -->
<figure class="wp-block-image size-large ikizler-card-media has-custom-border"><img src="https://images.unsplash.com/photo-1515165562835-c4c2dd1b7ffb?auto=format&amp;fit=crop&amp;w=1000&amp;q=80" alt="Genc ve yetiskin bale dersi" style="border-radius:30px 30px 0 0"/></figure>
<!-- /wp:image -->

<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|sm","right":"var:preset|spacing|md","bottom":"0","left":"var:preset|spacing|md"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--sm);padding-right:var(--wp--preset--spacing--md);padding-bottom:0;padding-left:var(--wp--preset--spacing--md)"><!-- wp:paragraph {"className":"ikizler-section-label","textColor":"plum"} -->
<p class="ikizler-section-label has-plum-color has-text-color">Genc ve Yetiskin</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":3,"fontSize":"lg"} -->
<h3 class="wp-block-heading has-lg-font-size">Baslangic ya da ileri duzeyde daha kontrollu hareket dili</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Zarafet, beden farkindaligi ve teknik derinlik odakli dersler.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
